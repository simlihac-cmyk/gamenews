...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not apply:
            self.stdout.write(f"{len(findings)} item(s) would be quarantined. Use --apply to write changes.")
            return
        ...
        self.stdout.write(self.style.SUCCESS(f"{updated} item(s) quarantined."))
